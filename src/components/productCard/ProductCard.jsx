...
function ProductCard() {
    ...
    const filteredProducts = product.filter((obj) => {
        ...
        const matchesCategory = !filterType || 
            (obj.category && obj.category.toLowerCase() === filterType.toLowerCase());
            ...
            <section className="text-gray-600 body-font">
                <div className="container px-5 py-8 md:py-16 mx-auto">
                    <div className="lg:w-1/2 w-full mb-6 lg:mb-10">
                        ...
                        <p className="mt-4" style={{ color: mode === 'dark' ? 'white' : '' }}>
            ...
            <div className="container px-5 py-8 md:py-16 mx-auto">
                ...
                <div className="flex flex-wrap -m-4">
                    {filteredProducts.slice(0,8).map((item, index) => {
                        const { title, price, description, imageUrl, id, author } = item;
                        return (
